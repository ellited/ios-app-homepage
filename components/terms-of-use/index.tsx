...
function TermsOfUse() {
    return <div className={styles.wrapper}>
        <p>
            Elizaveta Rudenko built the "ABC Transport" app as a Free app. This SERVICE is provided by Elizaveta Rudenko
            at no cost and is intended for use as is.
        </p>

        <p>
            This page is used to inform website visitors regarding my policies with the collection, use, and disclosure
        ...
        <p>
            ...
            accessible at "ABC Transport" unless otherwise defined in this Privacy Policy.
        </p>
        ...
        <p>
            ...
            identifiable information. The information that I request is retained on your device and is not collected by
            me in any way.
        </p>
        ...
        <p>
            ...
            <ul>
                ...
                <li>
                    <a href="https://fabric.io/privacy">
                        Fabric
                    </a>
                </li>

                <li>
                    <a href="http://try.crashlytics.com/terms/privacy-policy.pdf">
                        Crashlytics
                    </a>
                </li>
            </ul>
        ...
        <p>
            This mobile application complies with the Children’s Online Privacy Protection Act (“COPPA”). I do not
            knowingly
            ...
            or
            guardian and you are aware that your child has provided us with personal information, please contact me so
            that
        ...
        <p>
            ...
            for
            any changes. I will notify you of any changes by posting the new Privacy Policy on this page. These changes
            are
